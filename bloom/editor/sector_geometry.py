...
class SectorGeometry:
    def __init__(self, scene: core.NodePath, name: str, tile_manager: manager.Manager):
        self._scene = scene
        self._name = name
        ...
        self._sprite_geometry = sprite_geometry.SpriteGeometry(
            self._display, self._tile_manager
        )
    ...
    def add_2d_geometry(
        ...
        if not constants.PORTALS_DEBUGGING_ENABLED:
            self._add_2d_segments(
                self._2d_segments, point_1, point_2, colour, thickness=thickness
            )
            self._add_2d_vertex_segments(self._2d_segments, point_1, colour)

    def add_2d_highlight_geometry(
        self, name: str, point_1: core.Point2, point_2: core.Point2
    ):
    ...
    def add_vertex_highlight_geometry(
        self, point: core.Point2, bottom: float, top: float, part: str
    ):
    ...
    @staticmethod
    def _add_2d_vertex_segments(
        segments: core.LineSegs, point: core.Point2, colour: core.Vec4
    ):
    ...
    def _create_3d_segments(
        self, point_1: core.Point3, point_2: core.Point3, colour: core.Vec4
    ):
