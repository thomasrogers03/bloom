...
class FindInMarquee:
    ...
    def __init__(self, sectors: typing.List[map_objects.EditorSector], start: core.Point2, end: core.Point2):
    ...
    def _point_in_marquee(self, point: core.Point2):
        return point.x >= self._start.x and point.x <= self._end.x and \
            point.y >= self._start.y and point.y <= self._end.y