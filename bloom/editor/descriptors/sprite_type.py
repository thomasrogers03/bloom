...
class SpriteType:
    ...
    def get_sprite_properties(
        self, sprite: map_objects.EditorSprite, droppables: typing.Dict[str, int]
    ):
        ...
        properties: typing.Dict[str, object_property.Property] = {
            ...
            "Skill 1": object_property.Property.create_boolean(
                data.launch_1, offset=True
            ),
            "Skill 2": object_property.Property.create_boolean(
                data.launch_2, offset=True
            ),
            "Skill 3": object_property.Property.create_boolean(
                data.launch_3, offset=True
            ),
            "Skill 4": object_property.Property.create_boolean(
                data.launch_4, offset=True
            ),
            "Skill 5": object_property.Property.create_boolean(
                data.launch_5, offset=True
            ),
            "Bloodbath": object_property.Property.create_boolean(
                data.launch_B, offset=True
            ),
            "Cooperative": object_property.Property.create_boolean(
                data.launch_C, offset=True
            ),
            ...
            "Drop Item": object_property.Property.create_enum(
                data.drop_item, droppables
            ),
        }
