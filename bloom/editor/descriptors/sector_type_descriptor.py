...
class SectorTypeDescriptor:
    ...
    def get_sector_type_properties(self, sector: map_objects.EditorSector):
        ...
        properties: typing.Dict[str, object_property.Property] = {
            ...
            'Motion Wave At On': object_property.Property.create_enum(data.on_wave, object_property.Property.WAVE_ENUM),
            'Wait At On': object_property.Property.create_boolean(data.on_wait_set),
            'Wait Time At On': object_property.Property.create_integer(data.on_wait_time),

            'Send At Off': object_property.Property.create_boolean(data.send_at_off),
            'Busy Time Off': object_property.Property.create_integer(data.off_busy_time),
            'Motion Wave At Off': object_property.Property.create_enum(data.off_wave, object_property.Property.WAVE_ENUM),
            'Wait At Off': object_property.Property.create_boolean(data.off_wait_set),
            'Wait Time At Off': object_property.Property.create_integer(data.off_wait_time),
