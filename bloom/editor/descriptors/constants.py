...
def _load_sector_descriptors():
    result: typing.Dict[int, sector_type_descriptor.SectorTypeDescriptor] = {}
...
def _load_wall_descriptors():
    result: typing.Dict[int, wall_type_descriptor.WallTypeDescriptor] = {}
...
reverse_sector_type_lookup = {
    descriptor.name: descriptor.sector_type for descriptor in sector_types.values()
}
