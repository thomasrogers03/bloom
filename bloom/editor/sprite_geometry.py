...
class SpriteGeometry:
    ...
    def add_facing_sprite(
        ...
        display, display_3d = self._new_display(
            name, picnum, lookup, blocking, centring, one_sided, theta
        )
    ...
    def add_directional_sprite(
        ...
        display, _ = self._new_display(
            name, picnum, lookup, blocking, centring, one_sided, theta
        )

        return display

    def add_floor_sprite(
        self,
        name: str,
        collision_tags: dict,
        picnum: int,
    ...
    def _new_display(
        ...
        display: core.NodePath = parent_display.attach_new_node(
            self._card_maker.generate()
        )
