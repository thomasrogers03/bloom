...
class BuildSprite(data_loading.CustomStruct):
    ...
    stat_number: data_loading.Int16
...
class BloodSpriteData(data_loading.CustomStruct):
    ...
    unknown2: data_loading.PartialInteger(data_loading.UInt8, 6)
    state: data_loading.PartialInteger(data_loading.UInt8, 1)
    unknown3: data_loading.PartialInteger(data_loading.UInt8, 1)
    ...
    unknown6: data_loading.PartialInteger(data_loading.UInt32, 5)
    ...
    unknown7: data_loading.PartialInteger(data_loading.UInt16, 1)
    ...
    unknown8: data_loading.PartialInteger(data_loading.UInt16, 2)
    ...
    unknown9: data_loading.UInt8

    unknown10: data_loading.PartialInteger(data_loading.UInt8, 5)
    locked: data_loading.PartialInteger(data_loading.UInt8, 1)
    unknown11: data_loading.PartialInteger(data_loading.UInt8, 2)

    respawn: data_loading.PartialInteger(data_loading.UInt32, 2)
    data4: data_loading.PartialInteger(data_loading.UInt32, 16)
    unknown13: data_loading.PartialInteger(data_loading.UInt32, 6)
    lock_msg: data_loading.PartialInteger(data_loading.UInt32, 8)

    unknown14: data_loading.UInt8

    unknown15: data_loading.PartialInteger(data_loading.UInt8, 4)
    ...
    unknown16: data_loading.SizedType(data_loading.UInt8, 26)
